some apps in this folder(aicoded) might be suboptimal, weird or half baked etc, 
...
i am currently developing ai swarm etc too so i might rewrite some of the stuff here by that
the stuff i use more are usually more polished,
you can use files in main folders for those,
but  no guarantee if i will add half baked ones to there şn future or not
